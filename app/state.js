export default {
  layers: [
    ...
    { id: 'y1991-09-25', label: 'September 25, 1991' },
    ...
    { id: 'y1995-09-15', label: 'September 15, 1995' },
    { id: 'y1995-12-14', label: 'December 14, 1995' },
    { id: 'y1998-01-15', label: 'January 15, 1998' },
    { id: 'y2006-06-05', label: 'June 5, 2006' },
    { id: 'y2008-02-17', label: 'February 17, 2008' }
  ],
  currentLayerIdx: 0
};
